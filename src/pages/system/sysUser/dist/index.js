...
var PasswordForm_1 = require("./PasswordForm");
var service_1 = require("@/pages/user/login/service");
var ResponseCodeEnum_1 = require("@/constants/ResponseCodeEnum");
var OBtnUpload_1 = require("@/components/OBtnUpload");
var CommonUtils_1 = require("@/global/CommonUtils");
/**
 * 模块主页面
 */
var SysUserTableList = function () {
    ...
    var _d = react_1.useState(false), passwordModalVisible = _d[0], handlePasswordModalVisible = _d[1];
    var _e = react_1.useState({}), editFormValues = _e[0], setEditFormValues = _e[1];
    var _f = react_1.useState({}), viewFormValues = _f[0], setViewFormValues = _f[1];
    var _g = react_1.useState(false), submitting = _g[0], setSubmitting = _g[1];
    var actionRef = react_1.useRef();
    var _h = react_1.useState({}), params = _h[0], setParams = _h[1];
    var columns = __spreadArrays(Columns_1["default"], [
        {
            ...
            render: function (_, record) { return (react_1["default"].createElement(antd_1.Space, { split: react_1["default"].createElement(antd_1.Divider, { type: "vertical" }), size: [0, 8], wrap: true },
                ...
                react_1["default"].createElement("a", { title: "\u5220\u9664", onClick: function () {
                        var selectedIds = [];
                        record.userId && selectedIds.push(record.userId);
                        HandleOps_1.handleRemoveSysById(selectedIds, actionRef, NamespaceEnum_1["default"].SysUser);
                    } },
    ...
    return (react_1["default"].createElement(pro_layout_1.PageHeaderWrapper, null,
        DeviceUtils_1.isMobile() ? react_1["default"].createElement(nativeList_1["default"], { handleModalVisible: function (e) { return handleModalVisible(e); }, setViewFormValues: function (e) { return setViewFormValues(e); }, setEditFormValues: function (e) { return setEditFormValues(e); }, handleUpdateModalVisible: function (e) { return handleUpdateModalVisible(e); }, handleViewModalVisible: function (e) { return handleViewModalVisible(e); }, handleRemove: function (id, actionRefs) { return HandleOps_1.handleRemoveSys(id, actionRefs, NamespaceEnum_1["default"].SysUser); } }) :
            react_1["default"].createElement(pro_table_1["default"], { actionRef: actionRef, rowKey: "userId", toolBarRender: function (action, _a) {
                    ...
                    return CommonService_1.retrievePageList(requestParams, NamespaceEnum_1["default"].SysUser);
        ...
        createModalVisible && react_1["default"].createElement(CreateForm_1["default"], { onSubmit: function (value) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            setSubmitting(true);
                            return [4 /*yield*/, HandleOps_1.handleAddSys(value, NamespaceEnum_1["default"].SysUser)];
                        case 1:
                            success = _b.sent();
                            setSubmitting(false);
                            if (success) {
        ...
        updateModalVisible && react_1["default"].createElement(UpdateForm_1["default"], { onSubmit: function (value) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            setSubmitting(true);
                            return [4 /*yield*/, HandleOps_1.handleUpdateSys(value, NamespaceEnum_1["default"].SysUser)];
                        case 1:
                            success = _b.sent();
                            setSubmitting(false);
                            if (success) {
        ...
        passwordModalVisible && react_1["default"].createElement(PasswordForm_1["default"], { onSubmit: function (value) { return __awaiter(void 0, void 0, void 0, function () {
                var res;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            setSubmitting(true);
                            return [4 /*yield*/, service_1.resetPassword({
                                    userId: value.userId,
                        ...
                        case 1:
                            res = _b.sent();
                            setSubmitting(false);
                            if ((res === null || res === void 0 ? void 0 : res.code) === ResponseCodeEnum_1["default"].SUCCESS) {
                ...
                handlePasswordModalVisible(false);
                // setEditFormValues({});
            }, passwordModalVisible: passwordModalVisible, submitting: submitting, values: editFormValues }),
...
exports["default"] = SysUserTableList;
