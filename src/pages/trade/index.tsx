...
const TradeTableList: React.FC<{}> = () => {
  ...
  const columns: ProColumns<Trade>[] = [
    ...TradeColumns,
    {
      title: '操作',
      dataIndex: 'option',
        ...
        <>
          ...
          <a
            onClick={() => {
              ...
              handleRemove(selectedIds,actionRef,NamespaceEnum.Trade);
            }}
          >
            删除
          </a>
    ...
    <PageHeaderWrapper>
      <ProTable<Trade>
        ...
        toolBarRender={(action, { selectedRows }) => [
          ...
          <OBtnUpload url={constructImportUrl(NamespaceEnum.Trade)}/>,
            ...
            overlay={
              <Menu
                onClick={async e => {
                  ...
                  if (e.key === 'delete') {
                    await handleRemove(selectedIds,actionRef,NamespaceEnum.Trade);
                    action.reload();
                  }
                  else if (e.key === 'export') {
                    await handleExport(NamespaceEnum.Trade,selectedIds);
                  }
                  else if (e.key === 'exportAll') {
                    await handleExport(NamespaceEnum.Trade);
                  }
                }}
                selectedKeys={[]}
              >
        ...
        params={params}
        request={params => {
                	                	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	                	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	                	        	                        	                	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                        	        	                          return retrievePageList(params, NamespaceEnum.Trade);
        }}
        columns={columns}
      ...
      <CreateForm
        onSubmit={async value => {
          setSubmitting(true)
          const success = await handleAdd(value,NamespaceEnum.Trade);
          setSubmitting(false);
          if (success) {
      ...
      <UpdateForm
        onSubmit={async value => {
          setSubmitting(true)
          const success = await handleUpdate(value,NamespaceEnum.Trade);
          setSubmitting(false);
          if (success) {
