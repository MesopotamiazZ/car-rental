...
export interface FormValueType extends Partial<SysUserRole> {
}

export interface ViewFormProps {
  onCancel: (flag?: boolean, formVals?: FormValueType) => void;
  viewModalVisible: boolean;
  values: Partial<SysUserRole >;
}

export interface ViewFormState {
}

const ViewSysUserRoleForm: React.FC<ViewFormProps> = props => {
  const {
...
export default ViewSysUserRoleForm;
